...
async function main() {
  try {
    ...
    // const url = 'https://www.googleapis.com/drive/v3/about?fields=appInstalled%2CcanCreateTeamDrives%2CexportFormats%2CfolderColorPalette%2CimportFormats%2Ckind%2CmaxImportSizes%2CmaxUploadSize%2CstorageQuota%2CteamDriveThemes%2Cuser';
...
function getcredsfromFile(token) {
    const oAuth2Client = new OAuth2Client(
      keys.installed.client_id,
      keys.installed.client_secret,
      keys.installed.redirect_uris[0]
    );
    oAuth2Client.setCredentials = JSON.parse(fs.readFileSync(token));
}
